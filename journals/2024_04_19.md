...
authors:: [[Kathrin Doerfler]] 
type:: [[article]]
read-status:: [[read]]
published:: [[2018]] 
link:: ![Strategies_for_Robotic_In_situ_Fabrication_opt.pdf](../assets/Strategies_for_Robotic_In_situ_Fabrication_opt_1713538023525_0.pdf) 
additional-links::
major-themes::
minor-themes::
	- #### Content:
...
- ### Craft-Based Methods for Robotic Fabrication: A Shift in Architectural Education
  background-color:: green
  authors:: [[Mayor-Luque, Dubor, Marengo]]
  type:: [[article]]
  read-status:: [[read]]
  published:: [[2021]] 
  link:: ![Craft-based_methods_for_robotic_fabrication_a_shif_1707851964661_0.pdf](../assets/Craft-based_methods_for_robotic_fabrication_a_shif_1707851964661_0_1713533525169_0.pdf) 
  additional-links::
  major-themes:: #craft #roboticfabrication #materialsexploration 
  minor-themes::
	- #### Content:
	-
	- #### Image:
	  ![image.png](../assets/image_1713533581015_0.png){:height 500, :width 500}
-
- ### The Savill Garden Gridshell Design and Construction
  ...
  read-status:: [[read]]
  published:: [[2008]] 
  link:: ![WCTE_2008_Harris_and_Roynon_Savill_1707733612253_0.pdf](../assets/WCTE_2008_Harris_and_Roynon_Savill_1707733612253_0_1713533455222_0.pdf) 
  additional-links::
  major-themes::
  minor-themes::
	- #### Content:
	...
	- #### Image:
	  [PASTE IMAGE HERE]{:height 300, :width 400}
-
- ### Polydome: A Timber Shell, Swizterland
  background-color:: green
  authors:: [[Julius Natterer John MacIntyre]] 
  type:: [[article]]
  read-status:: [[read]]
  published:: [[1993]] 
  link:: ![Polyd_me_A_Timber_Shell_Switzerland_1707741222217_0.pdf](../assets/Polyd_me_A_Timber_Shell_Switzerland_1707741222217_0_1713533275041_0.pdf) 
  additional-links::
  major-themes::
  minor-themes::
	- #### Content:
...
- ### Frei Otto and the Development of Gridshells
  ...
  read-status:: [[read]]
  published:: [[2015]] 
  link:: ![Frei_Otto_and_the_Development_of_Gridshells_1707674166245_0.pdf](../assets/Frei_Otto_and_the_Development_of_Gridshells_1707674166245_0_1713532839962_0.pdf) 
  additional-links::
  major-themes:: #gridshell #engineering #design #construction
  minor-themes:: #hangingmodel #soapfilmstudies
	- #### Content:
	- Otto’s work with Stromeyer in the late 50s and early 60s was based on using physical formﬁnding models to deﬁne the shape and then in the case of tents develop the fabric cutting patterns
	- Inverted hanging net model
		- Robert Hooke used this method to show Christopher Wren how the Dome of St. Paul’s might work
		- Otto adopted this method to explore light-weight shells
		- Mainly explored how timber laths or thin steel rods could be arranged in a **gridshell** (gitterschale)
	- Gridshell exploration and prototyping
		- Otto built a trial structure of a dome standing on four points using steel rods at **Berkeley**
		- trial structure structure in **Essen** (15m x 15m super-elliptical plan)
		- **Montreal** Expo 67 gridshell -- prefabricated in Germany and sent to Canada folded into bundles
		- **Mannheim** 1975
	- Frei Otto developed the concept of **gridshells** which could be designed by a funicular modelling method and constructed from an equal mesh net of timber laths bent into the planned shape
	- In 1970 this technique was used to construct a 9000 m2 curved roof structure from 5 cm square timber laths. This **paper summarises the design and engineering** work that went into the construction of this remarkable building.
	- #### Image:
		- ![image.png](../assets/image_1713532909967_0.png){:height 400, :width 400}
-
- ### Human-Machine Reconfigurations
  ...
  read-status:: [[read]]
  published:: [[2007]] 
  link:: ![suchman_humanmachinereconfigurations_1707312641900_0.pdf](../assets/suchman_humanmachinereconfigurations_1707312641900_0_1713532612119_0.pdf) 
  additional-links::
  major-themes:: #CROSS2024 
  minor-themes:: #interaction #humanmachinecommunication #HRI #industrialrobotics
	- #### Content:
		- **IMPORTANT CHAPTERS:**
